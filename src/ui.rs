...
fn describe(a: crate::keys::Action) -> &'static str {
    ...
    match a {
        ...
        A::SearchNext => "next match, or next hunk when nothing is searched",
        A::SearchPrev => "previous match, or previous hunk",
        A::ClearSearch => "clear the search, so n steps between hunks again",
        ...
        A::TreeToggleAll => "collapse everything, or expand it all back",
